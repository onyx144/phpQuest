...
<div class="container_big content_hints">
	...
	<div class="active_hints">
		<img src="<?= BASE_URI ?>/images/active_hints_bg.png" class="active_hints_bg" alt="">
		<div class="active_hints_content">
			<div class="active_hints_score">
				<img src="<?= BASE_URI ?>/images/active_hints_score_bg.png" class="active_hints_score_bg" alt="">
	...
	<div class="list_hints">
		<img src="<?= BASE_URI ?>/images/list_hint_bg.png" class="list_hints_bg" alt="">
