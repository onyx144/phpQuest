...
var demoMode = function() {
    ...
    "light" == (e = C.colorScheme) ? (S.disabled = !1,
    y.disabled = !0,
    ...
    t = C.navColor,
    f && h && d && ("default" == t ? (f.classList.add("navbar-light"),
    h.classList.add("navbar-light"),
    d.classList.add("navbar-light")) : "inverted" == t ? (f.classList.add("navbar-dark"),
    h.classList.add("navbar-dark"),
    d.classList.add("navbar-dark")) : "vibrant" == t && (f.classList.add("navbar-dark", "navbar-vibrant"),
    ...
    $(o).find('[name="navPosition"][value="' + r + '"]').closest(".btn").button("toggle"),
    $(o).find('[name="navColor"][value="' + n + '"]').closest(".btn").button("toggle"),
...
function() {
    ...
    function f(e, t, a) {
        ...
        t && (o.length ? t.classList.add("show") : t.classList.remove("show"),
...
function() {
    ...
    function r(e) {
        if (!e.id || !e.element || !e.element.dataset.avatarSrc)
            return e.text;
        var t = e.element.dataset.avatarSrc
          , a = document.createElement("div");
        return a.innerHTML = '<span class="avatar avatar-xs mr-3"><img class="avatar-img rounded-circle" src="' + t + '" alt="' + e.text + '"></span><span>' + e.text + "</span>",
        a
    }
