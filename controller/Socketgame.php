...
class Socketgame 
{
    ...
    // public function sendHeaders($headersText, $newSocket, $host)
    {
        $headers = array();
        $tmpLine = preg_split("/\r\n/", $headersText);
        ...
        /*$strHeadr = "HTTP/1.1 101 Switching Protocols \r\n" .
            ...
            "WebSocket-Location: ws://$host:$port/server_game.php\r\n".
        ...
        $strHeadr = "HTTP/1.1 101 Switching Protocols \r\n" .
            ...
            "Connection: Upgrade\r\n" .
            "WebSocket-Origin: $host\r\n" .
            "WebSocket-Location: wss://$host:$port/server_game.php\r\n".
            "Sec-WebSocket-Accept:$sKey\r\n\r\n"
        ;
        /*$strHeadr = "HTTP/1.1 101 Switching Protocols \r\n" .
            "Upgrade: websocket\r\n" .
        ...
        /*$strHeadr = "HTTP/1.1 101 Switching Protocols \r\n" .
            ...
            "Connection: Upgrade\r\n" .
            "WebSocket-Origin: $host\r\n" .
            "WebSocket-Location: wss://$host/server_game.php\r\n".
            "Sec-WebSocket-Accept:$sKey\r\n\r\n"
        ;*/
    ...
    public function createChatMessage($op, $parameters)
    {
        $messageArray = [
            'op' => $op,
