...
<div class="dashboard_tabs cyber-panel animate-fade-in-up" data-dashboard="files">
	...
	<div class="dashboard_tab_content">
			...
			<!-- эта часть динамическая -->
			<div class="dashboard_tab_content_item dashboard_tab_content_item_active" data-tab="tab1">Files</div>
			<!-- end - эта часть динамическая -->
		</div>
	</div>
</div>